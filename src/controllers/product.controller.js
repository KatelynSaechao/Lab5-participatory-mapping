...
exports.addRecord = async(req, res) => {
    let {contributor, content, lat, lng, date, time, email} = req.body;
    // let currTime = new Date().toISOString();
    console.log('INSERT INTO "tblRecord"(contributor, content, lat, lng, date, time, email) VALUES ($1, $2, $3, $4, $5, $6, $7)',
        [contributor, content, lat, lng, date, time, email]);
    let {recordRows} = await db.query(
        'INSERT INTO "tblRecord"(contributor, content, lat, lng, date, time, email) VALUES ($1, $2, $3, $4, $5, $6, $7)',
        [contributor, content, lat, lng, date, time, email]
    )
    ...
    res.status(200).send({
        ...
        body: {
            record: {contributor, content, lat, lng, date, time, email}
        }
    })
};